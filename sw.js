/* SeatPlan PWA - Service Worker (v2.14-debug)
   교체용 sw.js (GitHub Pages 포함)

   ✅ 변경점
   1) 캐시 이름을 버전별로 변경: seatplan-pwa-v181
...
const CACHE_NAME = 'seatplan-pwa-v214-debug'

// 프로젝트 루트 기준(상대경로) - GitHub Pages의 서브경로 배포에도 안전
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=2.14-debug",
  "./app.js?v=2.14-debug",
  "./manifest.webmanifest?v=2.14-debug",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
  "./guide.html",
  "./faq.html",
